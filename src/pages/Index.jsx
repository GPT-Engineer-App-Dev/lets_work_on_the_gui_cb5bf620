        ...
        <Flex w="full" wrap="wrap" gap={10}>
          ...
          <Box w={{ base: "full", md: "65%" }} p={5} borderWidth="1px" borderRadius="lg">
            <VStack spacing={4}>
              ...
              <Textarea placeholder="Enter your message here..." mb={4} />
              <Button leftIcon={<FaPlus />} size="lg">
                Send Message
              </Button>
            </VStack>
          </Box>
          ...
          <VStack w={{ base: "full", md: "35%" }} spacing={5}>
            ...
            <Button leftIcon={<FaFileUpload />} colorScheme="teal">
              Upload New Avatar
            </Button>
            <HStack>
